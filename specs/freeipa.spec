...
%global selinux_policy_version 37
%endif

# Fix for TLS 1.3 PHA, RHBZ#1775158
%global httpd_version 2.2.9-2
%global bind_version 9.11.20-6

# support for passkey
%global sssd_version 2.5.0
...
BuildRequires:  python3-qrcode >= 5.0.0
...
%if 0%{?fedora} >= 36
Requires: authselect >= 1.2.0
%else
Requires: authselect >= 1.2
%endif
Requires: curl
